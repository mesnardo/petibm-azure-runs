# 3D flow around a snake cylinders (Re=2000, AoA=25deg, tandem, no stagger)
...
```bash
az storage file download-batch --source myfileshare/snake3d2k25_tandem_s0/ --destination output --account-name <storage-account-name>
```
