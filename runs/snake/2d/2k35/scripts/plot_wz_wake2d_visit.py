"""Visualize a pseudocolor of the 2D vorticity field with VisIt.

PNG files are saved in the sub-folder `figures` of the simulation directory.
"""
...
xdmf_path = simu_dir / 'output' / 'postprocessing' / 'wz' / 'wz.xmf'
name = 'wz'
config_view = simu_dir / 'scripts' / 'visit_view2d.yaml'
curve2d_path = simu_dir / 'output' / 'snake2d35.curve'
